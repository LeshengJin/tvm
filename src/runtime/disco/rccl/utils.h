 ...
 * under the License.
 */
#ifndef TVM_RUNTIME_DISCO_RCCL_UTILS_H_
#define TVM_RUNTIME_DISCO_RCCL_UTILS_H_
...
#define RCCL_CALL(cmd)                                       \
  do {                                                       \
    ncclResult_t r = cmd;                                    \
    if (r != ncclSuccess) {                                  \
      LOG(FATAL) << "RCCLErrror: " << ncclGetErrorString(r); \
    }                                                        \
  } while (0)
...
#endif  // TVM_RUNTIME_DISCO_RCCL_UTILS_H_
