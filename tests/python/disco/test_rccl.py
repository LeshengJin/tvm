...
#     sess.init_ccl("nccl", *devices)
#     d_array = sess.empty((3, 4), "float32")
#     d_array.debug_get_from_remote(0).copyfrom(array)
...
#         d_X.debug_get_from_remote(0).copyfrom(X)
#         d_X.debug_get_from_remote(1).copyfrom(X)
#         d_W1.debug_get_from_remote(0).copyfrom(W1[:, :64])
#         d_W1.debug_get_from_remote(1).copyfrom(W1[:, 64:])
#         d_W2.debug_get_from_remote(0).copyfrom(W2[:64, :])
#         d_W2.debug_get_from_remote(1).copyfrom(W2[64:, :])
